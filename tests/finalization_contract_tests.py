    ...
    action = parse_agent_action(
        {
            ...
            "policy_evidence_ids": [],
            "handoff_payload": {"summary": "User requested Okta admin access.", "requested_actions": [], "risk_type": "unmodeled_high_risk_request", "policy_gap": True},
            "confidence": 0.8,
    ...
    action = parse_agent_action(
        {
            ...
            "evidence_ids": ["obs_user"],
            "policy_evidence_ids": [],
            "handoff_payload": {"summary": "User requested Jenkins admin.", "requested_actions": [], "risk_type": "unmodeled_high_risk_request", "policy_gap": True},
            "confidence": 0.8,
            "thought_summary": "Escalate policy gap.",
        }
    )
